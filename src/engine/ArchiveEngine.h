...
public:
    ...
    virtual bool Extract(std::string_view entryName, std::string_view destPath) = 0;
    virtual bool ExtractAll(std::string_view destPath) = 0;
    virtual std::vector<uint8_t> ReadFile(std::string_view entryName) = 0;

    virtual bool AddFile(std::string_view srcPath, std::string_view archivePath) = 0;
    virtual bool RemoveEntry(std::string_view entryName) = 0;
    virtual bool Save() = 0;
